...
const Featured = () => {
  ...
  return (
    <>
      <h1 className="capitalize text-4xl md:text-6xl text-gray-900 text-center p-5 mt-5 font-extrabold ">New featured vehicles</h1>
        ...
        {cars.slice(3, 7).map((car) => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              {/* Price badge */}
              <span
                className="absolute top-3 right-3 bg-black/80 text-white text-sm font-semibold px-3 py-1 rounded-full"
              >
